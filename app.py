...
# Simulación de ingreso de datos\st.header("📥 Ingesta y Procesamiento de Datos")
st.markdown("""
...
# Módulo de IA\st.header("🧠 Módulo de IA para optimización")
st.markdown("""
...
# Visualización y monitoreo\st.header("📊 Panel de visualización")
st.markdown("""
